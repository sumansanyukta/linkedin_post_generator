...
const POST_CATEGORIES = [
  ...
  {
    name: "Personal Story",
    description: "Share your experiences and journey",
    engagement: "Very High",
    icon: "👤",
    examples: ["Career milestones", "Lessons learned", "Behind the scenes"],
  },
  {
    name: "Tips & Tricks",
    ...
    engagement: "High",
    icon: "💡",
    examples: ["Productivity hacks", "Tool recommendations", "Quick wins"],
  },
  {
    name: "Question/Poll",
    ...
    engagement: "Very High",
    icon: "❓",
    examples: ["Opinion polls", "Discussion starters", "Feedback requests"],
  },
  {
    ...
    engagement: "High",
    icon: "🎬",
    examples: ["Work environment", "Team culture", "Project updates"],
  },
  {
